...
with tab1:
    ...
    ''
    ''
    st.image("Pictures/Function_2/F2_archimate_google cloud.png", width=300)
...
with tab2:
    ...
    ''
    st.write("""
    - Here is more detailed overview of the 3 core Layers
    """)

    st.write("""
    - Including: 
        - Function 1 - Download
        - Function 2 - Data Parsing, Validation, Visualization and Generating .txt summary file
    """)
