...
if st.button("Submit", use_container_width=True):
    ...
    with tab_final_2:
        ...
        tab2_ov_time_truck = tab2_overall_time_truck_r2 - extra_time_tab2_truck
        tab2_ov_time_train = tab2_overall_time_train_r2 - extra_time_tab2_train
        tab2_ov_time_air = tab2_overall_time_air_r2 - extra_time_tab2_air
        ...
        df_tab2_extra_s = pd.DataFrame({
            ...
            "Price" : [money_insurance, money_fragile, money_danger],
        })
