...
with tab1:
    ''
    st.metric("Progress (yesterday)", value=f"{value_eur_to_czk_last:.3f}", delta=delta_eur_to_czk)
...
with tab2:
    ''
    st.metric("Progress (yesterday)", value=f"{value_usd_to_czk_last:.3f}", delta=delta_usd_to_czk)
    col1, col2, col3 = st.columns(3)
...
with tab3:
    ''
    st.metric("Progress (yesterday)", value=f"{value_eur_to_usd_last:.3f}", delta=delta_eur_to_usd)
    col1, col2, col3 = st.columns(3)
