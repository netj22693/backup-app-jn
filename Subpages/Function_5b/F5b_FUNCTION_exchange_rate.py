...
if st.button("cau"):
    ...
    df_cz_to_eur = df_split_data_clean_up(df_table_full, "cz_to_eur")
    df_cz_to_usd = df_split_data_clean_up(df_table_full, "cz_to_usd")
    df_eur_to_usd = df_split_data_clean_up(df_table_full, "eur_to_usd")

    # Creation of charts
    chart_cz_to_eur = create_chart(df_cz_to_eur, "created_at", "cz_to_eur", "#3206F5", "CZK to EUR", "EUR")
    chart_cz_to_usd = create_chart(df_cz_to_usd, "created_at", "cz_to_usd", "#111111", "CZK to USD", "USD")
...
st.plotly_chart(chart_cz_to_eur, use_container_width=True)
st.plotly_chart(chart_cz_to_usd, use_container_width=True)
